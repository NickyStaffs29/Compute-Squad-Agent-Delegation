...
description: |
  ...
  <commentary>
  Sonnet is the execution default; the orchestrating session routes to the Opus variant only when the PM flags complexity a tight spec cannot fully de-risk.
  </commentary>
  </example>
...
## Executor
<timestamp line>
Agent: squad-executor-opus (Opus)
