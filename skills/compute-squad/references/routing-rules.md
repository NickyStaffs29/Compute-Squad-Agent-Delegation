...
v3 structures roles by decision density: main session = strategy, Opus = PM, Haiku = intern, and execution routes to Haiku, Sonnet, or Opus according to the PM's own MECHANICAL, STANDARD, or COMPLEX classification.
