...
Risks:
- another account learns the invoice exists | the owner check runs after the PDF render, so a render error answers 500, not 404 (src/routes/invoices.js:34-36)
