...
- [intern] Regenerate the 40 fixtures under test/fixtures/importer/ from the
  ...
  most 2 lines. BLOCKING.

## Delegated — Executor
Timestamp: 2026-09-01T09:18:51Z

test/fixtures/importer/account.json: regenerated
test/fixtures/importer/address.json: regenerated
test/fixtures/importer/billing.json: regenerated
test/fixtures/importer/contact.json: regenerated
test/fixtures/importer/device.json: regenerated
