...
## Status
Timestamp: 2026-09-03T08:30:10Z
Run: 2026-09-02-export-dry-run
Mode: execute
Worktree: /home/dev/app, branch main
Base: 1a2b3c4
...
Classification: STANDARD. WO-1: as before, and src/cli/lock.js skips the lock
file when dryRun is set. WO-2: add one test per criterion to
test/export.test.js. Must NOT change: a real run's output. Verification plan:
npm test. Non-goals: the import command. Risks: none.

## Status
Timestamp: 2026-09-03T08:37:05Z
Run: 2026-09-02-export-dry-run
Mode: execute
Worktree: /home/dev/app, branch main
Base: 1a2b3c4
